 ...
 */
     ...
     && !defined(NEOVIM_VIML_PARSER_COMMAND_DEFINITIONS_H_DECLARED)) \
    || \
    (!defined(DO_DECLARE_EXCMD) \
     && !defined(NEOVIM_VIML_PARSER_COMMAND_DEFINITIONS_H_DEFINED_ENUM))
#ifdef DO_DECLARE_EXCMD
# define NEOVIM_VIML_PARSER_COMMAND_DEFINITIONS_H_DECLARED
#else
# define NEOVIM_VIML_PARSER_COMMAND_DEFINITIONS_H_DEFINED_ENUM
#endif
