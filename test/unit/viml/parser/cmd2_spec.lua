describe('parse_one_cmd', function()
  ...
  describe(':syntax', function()
    ...
    itn('syntax cluster AandB add=B\n" now both keywords are matched in Stuff', ':syntax cluster AandB add=B	  " now both keywords are matched in Stuff')
    itn('syntax keyword A aaa', ':syntax keyword A aaa')
    itn('syntax keyword B bbb', ':syntax keyword B bbb')
    ...
    itn('syntax cluster BigGroup remove=B\n" no effect, since B isn\'t in BigGroup', ':syntax cluster BigGroup remove=B	" no effect, since B isn\'t in BigGroup')
    itn('syntax cluster SmallGroup remove=B\n" now bbb isn\'t matched within Stuff', ':syntax cluster SmallGroup remove=B	" now bbb isn\'t matched within Stuff')
